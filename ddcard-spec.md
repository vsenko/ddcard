...
- квитанция доверенной третьей стороны должна быть встроена в CMS иностранной ЭЦП в виде неподписанного атрибута с идентификатором `1.2.840.113549.1.9.16.2.29` (RFC 3029 id-aa-dvcs-dvc);
