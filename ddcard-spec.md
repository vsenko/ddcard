...
Спецификация допускает исключительно те цифровые подписи, которые могут считаться равнозначными собственноручным подписям в соответствии с законодательством Республики Казахстан. В частности, это означает что сертификат (регистрационное свидетельство) подписавшей стороны должен быть выпущен одним из следующих удостоверяющих центров (Цифровой кодекс Республики Казахстан, статья 49, пункт 2, подпункт 4):
...
### Подтверждение для ЭЦП на основе сертификата, выпущенного аккредитованным удостоверяющим центром Республики Казахстан
...
### Подтверждение для иностранной электронной цифровой подписи
